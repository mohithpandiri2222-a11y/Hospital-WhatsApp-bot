...
def _step_confirm_name(phone: str, text: str, data: dict) -> str:
    ...
    return (
        ...
        f"Date: {fmt_date(result['date'])}\n"
        f"Time: {result['time']}\n"
        f"Token No: *{result['token']}*\n\n"
        "Hospital Location:\n"
        "https://www.google.com/maps/place/MedPlus+Visalakshi+Nagar/@17.7542614,83.339439,18.12z/data=!4m6!3m5!1s0x3a395b514b5b117d:0x8bdd010db7e56a9a!8m2!3d17.7548799!4d83.3384654!16s%2Fg%2F11cjvb_z5q?authuser=0&entry=ttu&g_ep=EgoyMDI2MDcxNS4wIKXMDSoASAFQAw%3D%3D\n\n"
        "Please arrive 10 minutes early. Bring this token number.\n\n"
